  ...
  ru: {
    story: {
      ...
      timeline: [
        ...
        {
          period: 'Сегодня',
          title: 'Пешеходные «зелёные лёгкие» города',
      ...
      legends: [
        {
          ...
          text: 'По преданию, дубы посадили сами запорожские казаки — в память о разрушенной в военные лихолетья Запорожской Сечи. Говорят, казаки сажали деревья со слезами на глазах, поэтому дубы так глубоко пустили корни и растут до сих пор, храня память о свободе этой земли.',
        },
        {
          title: '«Дуб Махно»',
  ...
  uk: {
    story: {
      ...
      timeline: [
        ...
        {
          period: 'Сьогодні',
          title: 'Пішохідні «зелені легенди» міста',
